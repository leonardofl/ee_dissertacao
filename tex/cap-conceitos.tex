...
\fabio{tem que explicar a figura.
a figura usa uma notação que não foi explicada.
faça essa figura bem maior verticalmente para ficar mais legível.}
...
\fabio{definição imprecisa para não dizer errada. Uma operação é idempotente quando aplicá-la várias vezes gera o mesmo resultado do que gerar uma única vez.}
