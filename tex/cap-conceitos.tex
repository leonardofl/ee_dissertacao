...
Para cada etapa do pipeline de implantação, o processo de implantação 
...
1) a máquina virtual deve ser criada com base em uma imagem
\footnote{\emph{Imagens} são sistemas de arquivo somente-leitura contendo um sistema operacional, aplicações e dados a serem instanciados em uma ou mais máquinas virtuais.} 
que já contenha
