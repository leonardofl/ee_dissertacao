...
Inicialmente, conduzimos uma análise multi-variada \fabio{ref}
...
\fabio{não tínhamos uma tabela mais informativa no artigo do CCGrid??}
...
cresceu aproximadamente apenas 3 vezes nos cenários 2 e 3 \fabio{não entendi. onde está mostrado isso???}.
...
o que dispara a re-execução de algumas rotinas. \fabio{explicação confusa e incompleta}

Os resultados também mostram que o quando o número de serviços por nó dobrou (cenário 4)
\fabio{dobrou em relação a o que??? não dá prá entender.},
