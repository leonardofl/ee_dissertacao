...
Neste capítulo, apresentamos um experimento qualitativo realizado 
com o Enactment Engine com objetivo de avaliar
seu uso do ponto de vista do implantador, 
contrastando com soluções \emph{ad-hoc} de implantação automatizada.
Também avaliamos quantitativamente o desempenho e escalabilidade do EE
para verificar a viabilidade de seu uso
no contexto de composições de serviços de grande escala.

O experimento qualitativo foi realizado com uma comparação do ``esforço''
...
Já para as avaliações quantitativas, criamos experimentos automatizados
...
3) medir e registrar os tempos de execução e
...
No experimento qualitativo (Seção~\ref{sec:avaliacao_eng_sw})
tentamos avaliar os benefícios de uma implantação baseada em \emph{middleware}
