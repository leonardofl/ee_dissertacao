...
\item possibilitar que JARs sejam empacotados em arquivos ZIPs para que a configuração possa ser adequadamente separada do binário do serviço.
\end{itemize}
