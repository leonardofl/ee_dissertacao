...
\fabio{Alterações no diagrama: criar -> crie; encenar -> encene; salvar -> salve; executar -> execute; etc.}
...
\begin{enumerate}
\item aprimoramento da detecção de falhas dos serviços da camada de IaaS, o que depende da avaliação da operação do \ee\ com outros provedores de IaaS (pretendemos utilizar uma instalação privada de OpenStack); \Leo{explicitar tb ``heurística para lidar com as falhas da Amazon''}
