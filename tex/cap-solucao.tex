...
%{fig:chef_arquitetura} 
FIGURA: Arquitetura do Chef.
...
%{fig:ee_distribuicao}
FIGURA: Distribuição da implantação dos componentes do Enactment Engine.
...
%{fig:ee_exemplo_distribuicao}
Exemplo de uso do Enactment Engine em diferentes organizações.
...
\item [ServiceSpec.version:] a versão do serviço. \leo{explicar mais}
