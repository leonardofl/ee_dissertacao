...
podem ser vistos na Seção~\ref{sec:implementacao}.
...
As classes criadas para a utilização do \textsf{Invoker}
...
ou um \emph{invoker} um pouco mais simples, que apenas
considere o timeout de uma chamada.
...
pode ser realizada dinamicamente sem que seja preciso alterar
