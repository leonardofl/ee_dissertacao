...
\noindent \textbf{Palavras-chave:} implantação de software, composições, coreografias, serviços web, computação em nuvem, grande escala.
...
\noindent \textbf{Keywords:} software deployment, compositions, choreography, web services, cloud computing, large scale.
