...
\begin{center}
    ...
    \vskip 0.5cm
    \normalsize{São Paulo, setembro de 2014}
\end{center}
...
\thispagestyle{empty}
	...
	realizada em 26/05/2014. Uma cópia da versão original está disponível no\\
    ...
    \begin{itemize}
		...
		\item Prof. Dr. Fabio Kon (coorientador) - IME-USP 
		\item Prof. Dr. Renato Fontoura de Gusmão Cerqueira - PUC-Rio
		\item Prof. Dr. Raphael Yokoingawa de Camargo - UFABC
    \end{itemize}
...
Paulo Moura, Carlos Eduardo Santos e Thiago Furtado.
