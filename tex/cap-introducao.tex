...
Esta pesquisa resultou na publicação do artigo \emph{Um Middleware para Encenação Automatizada de Coreografias de Serviços Web em Ambientes de Computação em Nuvem}, publicado no 31º Simpósio Brasileiro de Redes de Computadores e Sistemas Distribuídos (SBRC), em coautoria com Nelson Lago, Marco Aurélio Gerosa e Fabio Kon.
