...
conforme já sugerido por pesquisadores~\cite{Valerie2011FutureInternet} \gerosa{nomes ou mais refs}.
...
A arquitetura de nossa solução em função dos modelos de computação em nuvem pode ser observada na Figura~\ref{fig:modelos_nuvem}. \fabio{essa figura não mostra a arquitetura de nossa solução, ela mostra outra coisa.}
...
avaliações empíricas ligadas à implantação de composições de serviço, tendo assim potencial para alavancar diversas outras pesquisas sobre composições de serviços. \leo{fabio achou estranho o "para além" e o "praticantes"}
