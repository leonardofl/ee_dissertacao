...
como já é sugerido por pesquisadores~\cite{Valerie2011FutureInternet} \gerosa{nomes ou mais refs}.
...
e que a gerência programática de recursos virtualizados, fornecidos pela nuvem, favorece a criação de processos totalmente automatizado para a implantação de sistemas \cite{Humble2011Continuous} \gerosa{frase longa}.   
...
Esta pesquisa foi feita no contexto e com financiamento dos projetos CHOReOS e Baile, que estudaram a aplicação de composições de serviços distribuídas, chamadas \emph{coreografias}, em ambientes de grande escala. O projeto CHOReOS\footnote{\url{http://www.choreos.eu} \Gerosa{Colocar quando aparecem pela 1a vez.} \leo{??}}, financiado pela Comissão Europeia e composto por diversas instituições acadêmicas e industriais da Europa conjuntamente com o IME-USP, objetivou desenvolver um processo dinâmico e centrado no usuário para o desenvolvimento de coreografias em um ambiente de escala ultra grande, no qual milhares de serviços são compostos e coordenados por um middleware distribuído. O projeto Baile\footnote{\url{http://ccsl.ime.usp.br/baile} \Gerosa{Colocar quando aparecem pela 1a vez.} \leo{??}}, uma parceria entre IME-USP e HP Brasil, estudou a solução de problemas para o desenvolvimento de coreografias, como a adoção de Desenvolvimento Guiado por Testes (TDD) no contexto de coreografias e o suporte da Computação em Nuvem à implantação de coreografias.

As contribuições deste trabalho são: 

\begin{itemize}
\item Um levantamento \gerosa{é feito de maneira sistemática?}, baseado na literatura, dos desafios para a implantação de sistemas de grande escala, bem como os caminhos de soluções apontados pela literatura.
...
\Gerosa{falar dos artigos publicados, e na participação na escrita dos deliverables (citar quais).}
\Leo{cabe falar da revisão sistemática?}
