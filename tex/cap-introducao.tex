...
\todo{faltou definir implantação... pegar do DEPL de novo?}

No problema de implantação de sistemas, o princípio de iteratividade
...
A arquitetura de nossa solução em função dos modelos de computação em nuvem pode ser observada na Figura~\ref{fig:modelos_nuvem}. \fabio{essa figura não mostra a arquitetura de nossa solução, ela mostra outra coisa.} \todo{ligar EE às caixinhas em cima e em baixo?}
