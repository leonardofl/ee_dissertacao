...
pdftk ../tex/dissertacao.pdf cat 1-71 output parte1.pdf dont_ask 
pdftk ../tex/dissertacao.pdf cat 72-end output bibliografia.pdf dont_ask
...
sed -i 's/BookmarkPageNumber: 72/BookmarkPageNumber: 109/' metadata.txt
