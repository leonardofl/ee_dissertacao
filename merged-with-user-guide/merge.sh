...
pdftk ../tex/dissertacao.pdf cat 1-67 output parte1.pdf dont_ask 
pdftk ../tex/dissertacao.pdf cat 68-end output bibliografia.pdf dont_ask
...
sed -i 's/BookmarkPageNumber: 68/BookmarkPageNumber: 105/' metadata.txt
